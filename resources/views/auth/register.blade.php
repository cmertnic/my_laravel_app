    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-text-input id="password" class="block mt-1 w-full" placeholder="Пароль"
                ...
                <!-- midlename -->
                <div class="mt-4">
            <x-text-input id="midlename" class="block mt-1 w-full" type="text" name="midlename" :value="old('midlename')" required autofocus autocomplete="midlename" placeholder="Фамилия" />
        ...
        <!-- lastname -->
        <div class="mt-4">
            <x-text-input id="lastname" class="block mt-1 w-full" type="text" name="lastname" :value="old('lastname')" required autofocus autocomplete="lastname" placeholder="Очество" />
